...
## 4. 测试集（held-out test，2220 图 / 70,063 实例，EMA 权重 @maxDet100）

| 指标 | 论文复现 run (ep98) | 本 run (EMA, ep150) | Δ |
|---|---|---|---|
| **segm/mAP** | 0.7288 | **0.7342** | **+0.0054** |
| segm/mAP_50 | 0.9005 | 0.9131 | +0.0126 |
| segm/mAP_75 | 0.8402 | 0.8546 | +0.0144 |
| segm/mAP_s | 0.4354 | 0.4501 | +0.0147 |
| segm/AR@100 | 0.7689 | 0.7680 | -0.0009 |
| bbox/mAP | 0.7553 | 0.7643 | +0.0090 |
