#!/bin/bash
# =============================================================================
# RS4D-box @ NWPU VHR-10 实例分割对比实验（PromptMiner-SAM2 协议对齐版）
#
# 用法:
#   bash run_rs4d_nwpu.sh [mode] [gpu]
...
#     所有 shell 引用必须加引号
#   - 蒸馏初始化: models_after_dis/20250227-021854 noise_20_20_500k (models.py:1157 已接本地路径, 与 WHU 版相同)
#   - 超参保持 WHU-1024 版论文值: AdamW lr 9.2224e-5 wd 0.05, cosine+50iter warmup, LSJ-1024, bf16
#   - checkpoint 输出根: /data1/wangcheng/checkpoint/nwpu_vhr10_baselines/rs4d/<runtag>
# =============================================================================
set -uo pipefail
...
CFG="configs/rs4d/rs4d_prompt-nwpu-1024.py"
WORKDIR="/data1/wangcheng/checkpoint/nwpu_vhr10_baselines/rs4dprompt/rs4d_prompt_nwpu_bs8_bf16_800ep"
RUNTAG="rs4d_prompt_nwpu_bs8_bf16_800ep"
