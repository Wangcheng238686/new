...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/data/wangcheng/checkpoint/ablation_hyperparam_whu512_baseplus/whu512_iter2_dp4/best_model.pth}"
...
RUN_NAME="${RUN_NAME:-whu512_baseplus_nms$(echo "$NMS_IOU_THR" | tr -d .)}"
