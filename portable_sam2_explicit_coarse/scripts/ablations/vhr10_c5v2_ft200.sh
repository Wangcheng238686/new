...
RUN_TAG="${RUN_TAG:-vhr10_c5v2_ft200}"
...
echo "  epochs=${MAX_EPOCHS} lr=1e-4 (ft from c5v2 ep400) warmup=100 seed=44 amp=1"
...
exec "${PYTHON}" -m torch.distributed.run \
  ...
  --config configs/vhr10_baseplus_explicit_coarse.py \
  ...
  --lr 1e-4 \
  --warmup-iters 100 \
  --init-from /data/wangcheng/checkpoint/portable_sam2_explicit_coarse/ablations/vhr10_c5v2_400_tr1.0_va1.0/last_checkpoint.pth \
  --weight-decay 0.05 \
