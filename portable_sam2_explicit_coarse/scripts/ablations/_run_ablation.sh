...
P2_BOUNDARY_REFINER_BETA="${P2_BOUNDARY_REFINER_BETA:-0.20}"
...
SHAPE_DENSE_ALPHA_INIT="${SHAPE_DENSE_ALPHA_INIT:-0.25}"
SHAPE_DENSE_TEMPERATURE="${SHAPE_DENSE_TEMPERATURE:-1.0}"
...
export P2_BOUNDARY_REFINER_MID_CHANNELS P2_BOUNDARY_REFINER_BETA P2_BOUNDARY_REFINER_DELTA_LOGIT_MAX
export P2_BOUNDARY_REFINER_LOSS_WEIGHT
export SHAPE_DENSE_ALPHA_INIT SHAPE_DENSE_TEMPERATURE
...
echo "p2_boundary_refiner_beta=${P2_BOUNDARY_REFINER_BETA}"
...
echo "shape_dense_alpha_init=${SHAPE_DENSE_ALPHA_INIT}"
echo "shape_dense_temperature=${SHAPE_DENSE_TEMPERATURE}"
