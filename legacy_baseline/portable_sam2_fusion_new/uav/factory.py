...
from .sam2_backbone import SAM2BackboneForCVT, StandaloneSAM2Backbone
...
def build_cvt_encoder(
    ...
    if use_sam2_backbone:
        if shared_sam2_encoder is not None:
            ...
            model_size = drone_cfg.get("model_size", "base_plus")
            logger.info("Creating StandaloneSAM2Backbone with model_size=%s", model_size)
