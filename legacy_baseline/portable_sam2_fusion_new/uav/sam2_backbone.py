...
class StandaloneSAM2Backbone(nn.Module):
    ...
    def __init__(
        ...
        self.encoder = self._build_and_load_encoder(checkpoint_path, model_size)
    ...
    def _build_and_load_encoder(self, checkpoint_path: str, model_size: str = "base_plus") -> nn.Module:
        ...
        config = SAM2_MODEL_CONFIGS.get(model_size, SAM2_MODEL_CONFIGS["base_plus"])
        ...
        trunk = Hiera(
            ...
            window_pos_embed_bkg_spatial_size=config.get("window_pos_embed_bkg_spatial_size", (7, 7)),
        )
        ...
        logger.info(
            "Loaded %s model from %s. Missing keys: %d",
            model_size,
            checkpoint_path,
